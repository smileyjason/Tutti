...
class MainWindow(QDialog):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_add.setStyleSheet("font: 8pt Open Sans")
        self.pushButton_edit.setText(_translate("Dialog", "Edit"))
        self.pushButton_edit.setStyleSheet("font: 8pt Open Sans")
        self.pushButton_remove.setText(_translate("Dialog", "Remove"))
        self.pushButton_remove.setStyleSheet("font: 8pt Open Sans")
        ...
        self.pushButton_toggletheme.setStyleSheet("font: 8pt Open Sans")
        self.pushButton_quit.setText(_translate("Dialog", "Quit"))
        self.pushButton_quit.setStyleSheet("font: 8pt Open Sans")
        self.voiceButton.setText(_translate("Dialog", "Speech to Text"))
        self.voiceButton.setStyleSheet("font: 8pt Open Sans")
        self.pushButton_open.setText(_translate("Dialog", "Load"))
        self.pushButton_open.setStyleSheet("font: 8pt Open Sans")
        self.pushButton_save.setText(_translate("Dialog", "Save"))
        self.pushButton_save.setStyleSheet("font: 8pt Open Sans")
